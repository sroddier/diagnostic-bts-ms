/**
 * Collecte du diagnostic Unités et conversions.
 * Coller teacher/Code-a-coller.gs (généré) plutôt que ce fichier nu.
 */

var COPIES = "Copies";
var ITEMS = "Items";
var DOMAINES = ["PRE", "GEO", "MEC", "CIN", "ENE", "COH"];
...
function doGet() {
  return json_({ ok: true, service: "diagnostic-unites-bts-ms", session: "2026-unites" });
}
